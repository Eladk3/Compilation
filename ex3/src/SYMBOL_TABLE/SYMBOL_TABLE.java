...
public class SYMBOL_TABLE
{
	...
	private boolean isFunctionScope_ = false;
	private boolean isClassScope_ = false;
	...
	public void enter(String name,TYPE t)
	{
		...
		/**************************************************************************/
		SYMBOL_TABLE_ENTRY e = new SYMBOL_TABLE_ENTRY(name,t,hashValue,next,top,top_index++, scope, false);
	...
	public TYPE findInScopeDownTo(String name, int minimalScope) {
		...
		// Traverse the symbol table entries starting from the current scope
		for (e = top; e != null; e = e.prevtop) {
			// Check if the symbol matches the name and its scope is greater than or equal to the minimalScope
			if (name.equals(e.name) && e.scope >= minimalScope) {
				return e.type;
			}
		}
	...
	public void setIsInFunction(boolean b) 
	{
		isFunctionScope_ = b;
	...
	public void setCurrentClass(TYPE_CLASS cls)
	{
		currentClass = cls;
	}
	...
	public boolean thisTypeIsClassDec(TYPE type){
		SYMBOL_TABLE_ENTRY e;
